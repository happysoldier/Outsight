        ...
        <footer className="footer-dark">
            <div className="container">
                ...
                <div className="footer-nav-row">
                    ...
                    <Link to="/about">Medya</Link>
                    <Link to="/about">Mezunlar</Link>
                    <Link to="/about">Kariyer</Link>
                    <Link to="/contact">Ofisler</Link>
                ...
                <div className="footer-legal-row">
                    ...
                    <Link to="/contact">Yasal Uyarı</Link>
                    <Link to="/client-confidentiality">Müşteri Gizliliği</Link>
                    <Link to="/contact">Çerez Bildirimi</Link>
                </div>

                {/* Legal Links Row 2 */}
                <div className="footer-legal-row">
                    <Link to="/contact">Sorumlu Yapay Zeka Kullanımı</Link>
                    <Link to="/contact">Kişisel Bilgilerimi Satma veya Paylaşma</Link>
                </div>
